    ...
    for (device in data) {
        ...
        if (data[device].door.sensor == true) {
            if (data[device].door.state == "Normal") {
                ...
                document.getElementById(data[device].device.name + "_door_tooltip").innerHTML = (data[device].door.label) + " is open, which is normal during business hours";
        ...
        if (data[device].generator.sensor == true) {
            if (data[device].generator.state == "Normal") {
                document.getElementById(data[device].device.name + "_gen_tooltip").innerHTML = "Generator State is Normal with a Load of " + (data[device].generator.value) + " Amps";
                id.children(".generator").children().attr("src", "/static/img/generator_normal.png");
            } else if (data[device].generator.state == "Warning") {
                document.getElementById(data[device].device.name + "_gen_tooltip").innerHTML = "Generator State is Warning with a Load of " + (data[device].generator.value) + " Amps";
                id.children(".generator").children().attr("src", "/static/img/generator_warning.png");
            } else {
                document.getElementById(data[device].device.name + "_gen_tooltip").innerHTML = "Generator is Running with a Load of " + (data[device].generator.value) + " Amps";
